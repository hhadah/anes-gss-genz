...
pres_tabs <- paste0(git_mdir,"/presentations/nov-19-2023-sea-presentation/tables")
pres_plots <- paste0(git_mdir,"/presentations/nov-19-2023-sea-presentation/figures")
...
source(file.path(programs,"15-table-six-regressions-skin-iat-thirdgens-grandparents.R")) # with plots  
